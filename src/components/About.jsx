...
import mySelf from "../assets/images/myself.jfif";
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap justify-center md:justify- items-center gap-5">
              <div>
                <img
                  src={mySelf}
                  alt="Amaan Ansari - a passionate software engineer"
                  aria-label="Amaan Ansari - a passionate software engineer"
              ...
              <div className="md:text-left text-center w-full max-w-xl">
                ...
                <a
                  href="https://drive.google.com/file/d/18-dMDiYo61thfBigm-WjLLNWzDJbk1SN/view?usp=sharing"
                  target="_blank"
