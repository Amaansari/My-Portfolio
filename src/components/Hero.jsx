  ...
  return (
    ...
    >
      ...
      <div className="container">
        ...
        aria-label="I'm Amaan Ansari, a web developer with a passion for creating fast, scalable, and visually compelling applications."
        >
        I'm <span className="text-green-600">Amaan Ansari</span>, a{" "}
        <span className="text-yellow-500">web developer</span> passionate about
        crafting fast, scalable, and visually compelling web applications.
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-8 items-center justify-center">
          ...
          <motion.a
            ...
            transition={{ duration: 2 }}
            viewport={{ once: true }}
            href="https://www.linkedin.com/in/amaan-ansari-b49b06231"
            target="_blank"
